...
echo'	<fieldset>
			...
			<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
					...
					<input type="hidden" name="business" value="anhl3m@gmail.com">
					...
					<input type="hidden" name="return" value="http://localhost/thuctap/paypal_thanhcong.php">
					<!--Đường link mình cung cấp cho Paypal biết để nếu  xử lí KHÔNG thành công nó sẽ chuyển về theo đường link này-->
					<input type="hidden" name="cancel_return" value="http://localhost/thuctap/paypal_loi.php">
					<!-- Nút bấm. -->
