					...
					<div class="col-md-10 col-md-offset-3">
						...
						<?php
							...
							if(isset($_POST["submit"]))
							{
								...
								if($result)
								{
									header("Location: /thuctap/admin/chitiethoadon.php?maHD=$row[3]");
								}else{
							...
							<div class="form-group">
								<table>
									...
									<tr>
										...
										<td><input type="text" name="gia" class="form-control" value="<?php echo $row['1']?>"></td>
									</tr>
									<tr>
										<td><label>Số lượng</label></td>
										<td><input type="number" name="soluong" class="form-control" value="<?php echo $row['2']?>"></td>
									</tr>
									<tr>
										<td></td>
