...
<div class="container-fluid">
							...
							<div class="form-group">
								<table>
									...
									<tr>
										...
										<td><input type="number" id="soluong" name="tennhom" class="form-control" value="1"></td>
									</tr>
									<tr>
										<td></td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
									...
									echo '
                                    <tr>
										<td class="col-md-1">'.$row['machitiet'].'</td>
										<td class="col-md-1">'.$row['sanpham'].'</td>
                                        <td class="col-md-1">'.$row['soluong'].'</td>
                                        <td class="col-md-1">'.$row['gia'].'</td>
										<td class="col-md-1"><input type="image" src="/thuctap/images/icons/del.gif" onclick="del('.$row['machitiet'].')"/></td>
										<td class="col-md-1"><input type="image" src="/thuctap/images/icons/edit.png" onclick="edit('.$row['machitiet'].')"/></td>
									</tr>';
									}
									echo $paging->html();
									$paging=null;
	...
	<script src="/thuctap/js/admin/chitiethoadon.js"></script>
