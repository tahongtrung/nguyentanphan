...
<body>
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
										...
										<td style="width:10%"><input type="image" src="/thuctap/images/icons/del.gif" onclick="del('.$row['mataikhoan'].')"/></td>
										<td style="width:10%"><input type="image" src="/thuctap/images/icons/edit.png" onclick="edit('.$row['mataikhoan'].')"/></td>
                                    </tr>';
									}
									echo $paging->html();
									?>
	...
	<script src="/thuctap/js/admin/taikhoan.js"></script>
