...
<body>
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
										...
										<td class="col-md-1"><input type="image" src="/thuctap/images/icons/del.gif" onclick="del('.$row['manhom'].')"/></td>
										<td class="col-md-1"><input type="image" src="/thuctap/images/icons/edit.png" onclick="edit('.$row['manhom'].')"/></td>
                                    </tr>';
									}
									echo $paging->html();
									?>
	...
	<script src="/thuctap/js/admin/nhomsanpham.js"></script>
</body>
