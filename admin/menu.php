...
<div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                   <li>
					...
					<li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-table"></i> Khuyến mại & giảm giá chung <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="giamgiachung.php">Giảm giá chung</a>
                            </li>
                            <li>
                                <a href="khuyenmaichung.php">Khuyến mại chung</a>
                            </li>
                        </ul>
                    </li>
					<li>
