...
<head>
    ...
    <title>Thanh toán | World Water</title>
			...
			if(isset($_POST['thanhtoan']))
			{
				if(isset($_SESSION['username']))
				{
					...
					if($thanhtoan=="tructiep")
					{
						...
						$sql="Insert into hoadon(mataikhoan,ngaytao,tenkhachhang,sdt,diachi,hinhthucthanhtoan,ghichu,trangthai) values('$mataikhoan',NOW(),'$hoten','$sdt','$diachi','$thanhtoan','$ghichu',0)";
